...
// Formatowanie daty z zerami wiodącymi
...
function setClock(){
    date = new Date();
    time.innerHTML = "Czas: " + date.toLocaleTimeString("pl-PL", optionsTime) + " " + formatDate(date);    
    delay(1000).then(() => {
        setClock();
    })
}
...
if (localStorage.getItem("homeDate") == null){
  ...
  localStorage.setItem("homeDate", formatDate(homeDate))
}
